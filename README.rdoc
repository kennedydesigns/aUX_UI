...
* To dynamically add a new div, you can call the function addContentDiv(_id_,title,_content_);

    <script>AMUi.addContentDiv("newdiv","New Div","This is some new html");
